...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μKPG (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("KPGs");
    case mBTC: return QString("Milli-KPGs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-KPGs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
