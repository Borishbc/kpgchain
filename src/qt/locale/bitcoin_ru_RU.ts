...
<context>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к KPG идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть KPG.</translation>
    </message>
    <message>
        <source>Pay To:</source>
