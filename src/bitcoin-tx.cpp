...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kpg-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kpg-tx [options] <hex-tx> [commands]  Update hex-encoded kpg transaction\n" +
            "or:     kpg-tx [options] -create [commands]   Create hex-encoded kpg transaction\n" +
            "\n";
