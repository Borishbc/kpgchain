...
public:
    ...
    void SetNull()
    {
        ...
        nBits          = 0;
        nNonce         = 0;
        hashStateRoot  = uint256(); // kpg
        hashUTXORoot   = uint256(); // kpg
        vchBlockSig.clear();
    ...
    explicit CBlockIndex(const CBlockHeader& block)
    {
        ...
        nNonce         = block.nNonce;
        nMoneySupply   = 0;
        hashStateRoot  = block.hashStateRoot; // kpg
        hashUTXORoot   = block.hashUTXORoot; // kpg
        nStakeModifier = uint256();
        hashProof = uint256(); 
        prevoutStake   = block.prevoutStake; // kpg
        vchBlockSig    = block.vchBlockSig; // kpg
    }
